 ...
 */
package com.l2jserver.datapack.eventengine.ai;
...
//				html.setFile(l2PcInstance.getHtmlPrefix(), "data/eventengine/html/event_engine.htm");
...
//		}
	...
	{
		final NpcHtmlMessage html = new NpcHtmlMessage();
		html.setFile(player.getPcInstance().getHtmlPrefix(), "data/eventengine/html/event_info.htm");
	...
	{
		final NpcHtmlMessage html = new NpcHtmlMessage();
		html.setFile(player.getPcInstance().getHtmlPrefix(), "data/eventengine/html/event_lang.htm");
		// Info menu
	...
	{
		final NpcHtmlMessage html = new NpcHtmlMessage();
		html.setFile(player.getPcInstance().getHtmlPrefix(), "data/eventengine/html/event_buffs.htm");
	...
	{
		final NpcHtmlMessage html = new NpcHtmlMessage();
		html.setFile(player.getPcInstance().getHtmlPrefix(), "data/eventengine/html/npcdefault.htm");
		// Info
