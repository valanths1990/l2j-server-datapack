...
public final class MessageData
{
	...
	private static final String DIRECTORY = Configuration.server().getDatapackRoot()+"/data/eventengine/language";
	...
	private void load()
	{
		try
		{
			...
			for (File file : Objects.requireNonNull(dir.listFiles((FileFilter) pathname -> {
