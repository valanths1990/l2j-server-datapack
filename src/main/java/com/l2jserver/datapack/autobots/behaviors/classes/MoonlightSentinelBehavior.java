...
public class MoonlightSentinelBehavior extends CombatBehavior implements RequiresMiscItem, Kiter {

    public MoonlightSentinelBehavior(Autobot player, CombatPreferences combatPreferences) {
