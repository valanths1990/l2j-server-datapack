...
@JsonTypeName("pk")
public class PkBounty extends Bounty {

    @ConstructorProperties({ "base", "multiplier", "maxbounty", "transfer", "color", "rewards" })
    public PkBounty(double base, double multiplier, double maxBounty, double transfer, String color,
