...
@JsonTypeName("assist")
public class AssistBounty extends Bounty {

    @ConstructorProperties({ "base", "multiplier", "maxbounty", "transfer", "color", "rewards" })
    public AssistBounty(double base, double multiplier, double maxBounty, double transfer, String color,
    ...
    public AssistBounty(AssistBounty o) {
        this.base = o.base;
