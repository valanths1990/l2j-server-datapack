...
public class ClassHandler implements IBypassHandler {
	...
	private final String addClassButton = "<tr><td align=center><button value = \"%className%\"action=\"bypass class;homepage %action% %id%\"width=120 height=25 back=\"L2UI_ct1.button_df_down\"fore=\"L2UI_ct1.button_df\"></td></tr>";
	private final String transferAvailableButton = "  <button value=\"Transfer\" action=\"bypass class;homepage showtransferclass\" width=140 height=40 back=\"L2UI_ct1.button_df_down\"fore=\"L2UI_ct1.button_df\">";
	private final String transferButton = " <button value=\"%className%\" action=\"bypass class;homepage transfer %id%\" width=160 height=45 back=\"L2UI_ct1.button_df_down\" fore=\"L2UI_ct1.button_df\">";
	private final String changeClassButton = "<button value=\"%className%\" action=\"bypass class;homepage changeclass %id%\" width=130 height=30 back=\"L2UI_ct1.button_df_down\" fore=\"L2UI_ct1.button_df\">";
	...
	private final String learnPomanderSkillButton = "<button value=\"Learn Skills\" action=\"bypass class;homepage learnpomanderskill\" width=110 height=30 back=\"L2UI_ct1.button_df_down\" fore=\"L2UI_ct1.button_df\">";
	private final String resetPomanderSkillButton = "<button value=\"Reset Skill\" action=\"bypass class;homepage resetpomanderskill\" width=110 height=30 back=\"L2UI_ct1.button_df_down\" fore=\"L2UI_ct1.button_df\">";
	private final String HOLY_POMANDER = "HOLY_POMANDER_";
